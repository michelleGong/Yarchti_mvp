...
import com.yarward.mvp1test.archti_2_mvvmp.patient.patientDetail.databinder.PatientDataBinder;
import com.yarward.basemvp.databinder.DataBinder;
import com.yarward.basemvp.model.IBusiness;


import com.yarward.basemvp.presenter.DataBinderActivityPresenter;
 ...
 * Presenter
 */
public class PatientDetailActivity extends DataBinderActivityPresenter<PatientDetailViewDelegate> implements PatientDetailConstract.IPatientDetailPresenter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patientDetailBusiness = new PatientDetailBusiness((DemoApplication) getApplication());
        loadPatientInfo("123");
    }
            ...
            public void run() {
                ...
                mainHandler.post(new Runnable() {
                    ...
                    public void run() {
                       ...
                       //------viewModel------
                        notifyModelChanged(currentPatient);
                    }
                });
...
//                        viewDelegate.showPatientDetail(patient);
    ...
    public void loadPatientInfo(String patientId) {
        patientDetailBusiness.getpatientDetail("123", new PatientDetailConstract.IPatientDetailModel.PatientDetailCallback() {
            @Override
            public void ongetPatientSuccess(final Patient patient) {
                mainHandler.post(new Runnable() {
                    @Override
                    public void run() {
